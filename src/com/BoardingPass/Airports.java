...
//their Latitude and Longitude
    public Map<String, List<Double>> port() {
        ...
        jfkLatLon.add(40.6413);
        jfkLatLon.add(73.7781);
        iahLatLon.add(29.9902);
        iahLatLon.add(95.3368);
        sanLatLon.add(37.7749);
        sanLatLon.add(122.4194);
        miaLatLon.add(25.7617);
        miaLatLon.add(80.1918);
        laxLatLon.add(33.9416);
        laxLatLon.add(118.4085);
        lasLatLon.add(36.1699);
        lasLatLon.add(115.1398);
        phxLatLon.add(33.4484);
        phxLatLon.add(112.0740);
        hnlLatLon.add(21.3069);
        hnlLatLon.add(157.8583);
        msyLatLon.add(29.9911);
        msyLatLon.add(90.2592);
        detLatLon.add(42.3314);
        detLatLon.add(42.3314);
